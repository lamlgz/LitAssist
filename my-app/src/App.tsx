...
function App() {
  ...
  const [isLogoutSuccessModalOpen, setIsLogoutSuccessModalOpen] = useState(false); // 控制确认对话框的显示
  ...
  const [isRegisterSuccessModalOpen, setIsRegisterSuccessModalOpen] = useState(false); // 控制通知对话框的显示
      ...
      <div className="App">
        <aside className="sidebar">
          ...
          <ul>
            ...
            <li>
              <Link to={getSummaryLink()}>文献信息提取和总结</Link>
            </li>
            <li>
              <Link to="/translate">文献即时翻译</Link>
            </li>
            <li>
              <Link to="/format">文献格式转换</Link>
            </li>
            <li>
              <Link to="/chart">图表信息提取</Link>
            </li>
            <li>
              <Link to="/search">相关论文检索</Link>
            </li>
          </ul>
        </aside>
        ...
        <div className="auth-section">
          {isLoggedIn ? (
            ...
            <button onClick={() => setIsAuthFormOpen(true)}>登录/注册</button>
          )}
        </div>
